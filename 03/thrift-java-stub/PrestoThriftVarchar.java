...
public class PrestoThriftVarchar implements org.apache.thrift.TBase<PrestoThriftVarchar, PrestoThriftVarchar._Fields>, java.io.Serializable, Cloneable, Comparable<PrestoThriftVarchar> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PrestoThriftVarchar");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PrestoThriftVarcharStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PrestoThriftVarcharTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PrestoThriftVarchar.class, metaDataMap);
  }
   ...
   */
  public PrestoThriftVarchar(PrestoThriftVarchar other) {
    if (other.isSetNulls()) {
  ...
  @Override
  public PrestoThriftVarchar deepCopy() {
    return new PrestoThriftVarchar(this);
  }
  ...
  public PrestoThriftVarchar setNulls(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Boolean> nulls) {
    this.nulls = nulls;
    return this;
  }
  ...
  public PrestoThriftVarchar setSizes(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> sizes) {
    this.sizes = sizes;
    return this;
  }
  ...
  public PrestoThriftVarchar setBytes(byte[] bytes) {
    this.bytes = bytes == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(bytes.clone());
    return this;
  }

  public PrestoThriftVarchar setBytes(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer bytes) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof PrestoThriftVarchar)
      return this.equals((PrestoThriftVarchar)that);
    return false;
  }

  public boolean equals(PrestoThriftVarchar that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(PrestoThriftVarchar other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("PrestoThriftVarchar(");
    boolean first = true;
  ...
  private static class PrestoThriftVarcharStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public PrestoThriftVarcharStandardScheme getScheme() {
      return new PrestoThriftVarcharStandardScheme();
    }
  }

  private static class PrestoThriftVarcharStandardScheme extends org.apache.thrift.scheme.StandardScheme<PrestoThriftVarchar> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, PrestoThriftVarchar struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nulls = new java.util.ArrayList<java.lang.Boolean>(_list98.size);
                boolean _elem99;
                for (int _i100 = 0; _i100 < _list98.size; ++_i100)
                {
                  _elem99 = iprot.readBool();
                  struct.nulls.add(_elem99);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sizes = new java.util.ArrayList<java.lang.Integer>(_list101.size);
                int _elem102;
                for (int _i103 = 0; _i103 < _list101.size; ++_i103)
                {
                  _elem102 = iprot.readI32();
                  struct.sizes.add(_elem102);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrestoThriftVarchar struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.nulls != null) {
        if (struct.isSetNulls()) {
          oprot.writeFieldBegin(NULLS_FIELD_DESC);
          {
            ...
            for (boolean _iter104 : struct.nulls)
            {
              oprot.writeBool(_iter104);
            }
            oprot.writeListEnd();
          }
          oprot.writeFieldEnd();
  ...
  private static class PrestoThriftVarcharTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public PrestoThriftVarcharTupleScheme getScheme() {
      return new PrestoThriftVarcharTupleScheme();
    }
  }

  private static class PrestoThriftVarcharTupleScheme extends org.apache.thrift.scheme.TupleScheme<PrestoThriftVarchar> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PrestoThriftVarchar struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetNulls()) {
        {
          ...
          for (boolean _iter106 : struct.nulls)
          {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PrestoThriftVarchar struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      java.util.BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list108 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
          struct.nulls = new java.util.ArrayList<java.lang.Boolean>(_list108.size);
          boolean _elem109;
          for (int _i110 = 0; _i110 < _list108.size; ++_i110)
          {
            _elem109 = iprot.readBool();
            struct.nulls.add(_elem109);
          }
        }
        struct.setNullsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list111 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.sizes = new java.util.ArrayList<java.lang.Integer>(_list111.size);
          int _elem112;
          for (int _i113 = 0; _i113 < _list111.size; ++_i113)
          {
            _elem112 = iprot.readI32();
            struct.sizes.add(_elem112);
          }
        }
        struct.setSizesIsSet(true);
      }
