...
public class PrestoThriftJson implements org.apache.thrift.TBase<PrestoThriftJson, PrestoThriftJson._Fields>, java.io.Serializable, Cloneable, Comparable<PrestoThriftJson> {
  private static final org.apache.thrift.protocol.TStruct STRUCT_DESC = new org.apache.thrift.protocol.TStruct("PrestoThriftJson");
  ...
  private static final org.apache.thrift.scheme.SchemeFactory STANDARD_SCHEME_FACTORY = new PrestoThriftJsonStandardSchemeFactory();
  private static final org.apache.thrift.scheme.SchemeFactory TUPLE_SCHEME_FACTORY = new PrestoThriftJsonTupleSchemeFactory();
  ...
  static {
    ...
    org.apache.thrift.meta_data.FieldMetaData.addStructMetaDataMap(PrestoThriftJson.class, metaDataMap);
  }

  public PrestoThriftJson() {
  }

  /**
   * Performs a deep copy on <i>other</i>.
   */
  public PrestoThriftJson(PrestoThriftJson other) {
    if (other.isSetNulls()) {
  ...
  @Override
  public PrestoThriftJson deepCopy() {
    return new PrestoThriftJson(this);
  }
  ...
  public PrestoThriftJson setNulls(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Boolean> nulls) {
    this.nulls = nulls;
    return this;
  }
  ...
  public PrestoThriftJson setSizes(@org.apache.thrift.annotation.Nullable java.util.List<java.lang.Integer> sizes) {
    this.sizes = sizes;
    return this;
  }
  ...
  public PrestoThriftJson setBytes(byte[] bytes) {
    this.bytes = bytes == null ? (java.nio.ByteBuffer)null   : java.nio.ByteBuffer.wrap(bytes.clone());
    return this;
  }

  public PrestoThriftJson setBytes(@org.apache.thrift.annotation.Nullable java.nio.ByteBuffer bytes) {
  ...
  public boolean equals(java.lang.Object that) {
    if (that instanceof PrestoThriftJson)
      return this.equals((PrestoThriftJson)that);
    return false;
  }

  public boolean equals(PrestoThriftJson that) {
    if (that == null)
      return false;
    if (this == that)
      return true;
  ...
  @Override
  public int compareTo(PrestoThriftJson other) {
  ...
  public java.lang.String toString() {
    java.lang.StringBuilder sb = new java.lang.StringBuilder("PrestoThriftJson(");
    boolean first = true;
  ...
  private static class PrestoThriftJsonStandardSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public PrestoThriftJsonStandardScheme getScheme() {
      return new PrestoThriftJsonStandardScheme();
    }
  }

  private static class PrestoThriftJsonStandardScheme extends org.apache.thrift.scheme.StandardScheme<PrestoThriftJson> {

    @Override
    public void read(org.apache.thrift.protocol.TProtocol iprot, PrestoThriftJson struct) throws org.apache.thrift.TException {
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.nulls = new java.util.ArrayList<java.lang.Boolean>(_list162.size);
                boolean _elem163;
                for (int _i164 = 0; _i164 < _list162.size; ++_i164)
                {
                  _elem163 = iprot.readBool();
                  struct.nulls.add(_elem163);
                }
                iprot.readListEnd();
              }
            ...
            if (schemeField.type == org.apache.thrift.protocol.TType.LIST) {
              {
                ...
                struct.sizes = new java.util.ArrayList<java.lang.Integer>(_list165.size);
                int _elem166;
                for (int _i167 = 0; _i167 < _list165.size; ++_i167)
                {
                  _elem166 = iprot.readI32();
                  struct.sizes.add(_elem166);
                }
                iprot.readListEnd();
              }
    ...
    @Override
    public void write(org.apache.thrift.protocol.TProtocol oprot, PrestoThriftJson struct) throws org.apache.thrift.TException {
      struct.validate();
      ...
      if (struct.nulls != null) {
        if (struct.isSetNulls()) {
          oprot.writeFieldBegin(NULLS_FIELD_DESC);
          {
            ...
            for (boolean _iter168 : struct.nulls)
            {
  ...
  private static class PrestoThriftJsonTupleSchemeFactory implements org.apache.thrift.scheme.SchemeFactory {
    @Override
    public PrestoThriftJsonTupleScheme getScheme() {
      return new PrestoThriftJsonTupleScheme();
    }
  }

  private static class PrestoThriftJsonTupleScheme extends org.apache.thrift.scheme.TupleScheme<PrestoThriftJson> {

    @Override
    public void write(org.apache.thrift.protocol.TProtocol prot, PrestoThriftJson struct) throws org.apache.thrift.TException {
      ...
      if (struct.isSetNulls()) {
        {
          ...
          for (boolean _iter170 : struct.nulls)
          {
            oprot.writeBool(_iter170);
          }
        }
      }
      if (struct.isSetSizes()) {
    ...
    @Override
    public void read(org.apache.thrift.protocol.TProtocol prot, PrestoThriftJson struct) throws org.apache.thrift.TException {
      org.apache.thrift.protocol.TTupleProtocol iprot = (org.apache.thrift.protocol.TTupleProtocol) prot;
      java.util.BitSet incoming = iprot.readBitSet(3);
      if (incoming.get(0)) {
        {
          org.apache.thrift.protocol.TList _list172 = iprot.readListBegin(org.apache.thrift.protocol.TType.BOOL);
          struct.nulls = new java.util.ArrayList<java.lang.Boolean>(_list172.size);
          boolean _elem173;
          for (int _i174 = 0; _i174 < _list172.size; ++_i174)
          {
            _elem173 = iprot.readBool();
            struct.nulls.add(_elem173);
          }
        }
        struct.setNullsIsSet(true);
      }
      if (incoming.get(1)) {
        {
          org.apache.thrift.protocol.TList _list175 = iprot.readListBegin(org.apache.thrift.protocol.TType.I32);
          struct.sizes = new java.util.ArrayList<java.lang.Integer>(_list175.size);
          int _elem176;
          for (int _i177 = 0; _i177 < _list175.size; ++_i177)
          {
            _elem176 = iprot.readI32();
            struct.sizes.add(_elem176);
          }
        }
        struct.setSizesIsSet(true);
      }
